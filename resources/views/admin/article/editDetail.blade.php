      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="{{ action('Admin\ArticleController@updateDetail') }}" method="POST" class="form-horizontal form-label-left" novalidate>
              {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-11 col-sm-11 col-xs-12" id='detail'>{!! $content->content !!}
                </div>
