      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="{{ action('Admin\PostController@updateReplyDetail') }}" method="POST" class="form-horizontal form-label-left" novalidate>
              {{ csrf_field() }}
              <p>请输入 <code>修改回帖</code> 内容的相关信息
              </p>
              <span class="section">Reply Detail</span>

              <input type="hidden" name="id" value="{{ $reply->content->id }}">
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" >回帖内容</label>
                <div class="col-md-11 col-sm-11 col-xs-12" id='detail'>{!! $reply->content->reply !!}
                </div>
