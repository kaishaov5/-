...
<div id="article_con">
	...
	<!-- 主体表单模块 -->
	<form id="form" class="form-horizontal" action="<?php echo e(action('PublishController@storePost')); ?>" method="post">
		<div class="order">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select class="form-control" name="cate">
					...
					<option value="<?php echo e($cate->id); ?>" <?php if($cate->id == $cate_id): ?> selected <?php endif; ?>><?php echo e($cate->cate); ?></option>
