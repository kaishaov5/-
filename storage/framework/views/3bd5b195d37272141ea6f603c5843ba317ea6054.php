...
<!--搜索条-->
  <div class="head">
    <div class="head_center">
      <a style="background-image:url('<?php echo e($config->logo); ?>')" href="https://www.1980cang.com/" target="_blank" class="head_logo fl"></a>
...
<div class="nav">
  <div class="nav_center">
    ...
    <a href="<?php echo e(action('BbsController@index')); ?>" target="_blank">论坛</a>
    <?php if(Auth::check() && Auth::id()): ?>
    <a href="<?php echo e(action('PersonalController@index',Auth::id())); ?>">个人中心</a>
    <?php endif; ?>
  </div>
</div>
