      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="<?php echo e(action('Admin\ArticleController@updateCommentDetail')); ?>" method="POST" class="form-horizontal form-label-left" novalidate>
              <?php echo e(csrf_field()); ?>

              <p>所属文章 <code><?php echo e($comment->article->title); ?></code> 的评论
              </p>
            ...
            <div class="form-group">
                ...
                <div class="col-md-11 col-sm-11 col-xs-12" id='detail'><?php echo $comment->comment; ?>
