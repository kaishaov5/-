...
<div id="article_con">
	...
	<!-- 主体表单模块 -->
	<form id="form" class="form-horizontal" action="<?php echo e(action('PublishController@updateArticle')); ?>" method="post">
		<div class="order">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="name" name="name" value="<?php echo e($article->title); ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select class="form-control" name="cate">
					...
					<option value="<?php echo e($cate->id); ?>" <?php if($cate->id == $article->cate_id): ?> selected <?php endif; ?>><?php echo e($cate->cate); ?></option>
		...
		<div class="form-group">
			...
			<div class="col-sm-8" id='detail'><?php echo $article->content->content; ?></div>
