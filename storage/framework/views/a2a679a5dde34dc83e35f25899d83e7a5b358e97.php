...
<div class="htbox">
	...
	<div class="navigation">
	    ...
	    <div style="float: left;font-size: 14px;line-height: 25px ;height: 25px;">
	    	...
	    	<?php else: ?>
				...
				<a href=""><?php echo e($post->cate->cate); ?></a> →
	    	<?php endif; ?>
	...
	<div class="xml">
		<div class="xmll">
			<a href="<?php echo e(action('PublishController@post',['id'=>$post->cate->id])); ?>"><button class="btn btn-primary">发表帖子</button></a>
			<a href="<?php echo e(action('PublishController@reply',$post->id)); ?>"><button class="btn btn-danger">回复帖子</button></a>
		</div>
		<div class="xmlr">
		   	<p>
	...
	<div class="hfkt">
		<div class="hfktl">
			标题：<span><?php echo e($post->title); ?></span>
		</div>
		<div class="hfktr">
		</div>
	</div>
	...
	<?php $__currentLoopData = $replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   	<div <?php if($k%2==0): ?> class="hfktow" <?php else: ?> class="hfk" <?php endif; ?>>
		<div class="hfkl">
			<div class="hfklt">
				<div class="hfklt-l">
      ...
      <!--回复信息-->
		<div class="hfkr">
			<div style="height:21px;">
				...
				<div style="float:right;"><font color="red"><?php if($replies->currentPage() <= 1): ?><?php echo e(getLou($k+1)); ?><?php else: ?> <?php echo e(getLou(($replies->currentPage()-1)*10+$k+1)); ?> <?php endif; ?></font></div>
			</div>
        	<hr style="border-top: #6595d6 1px solid;width: 100%;height: 0px;margin:0px" />
	        <div style="min-height:200px;font-size:9pt;line-height:normal;text-indent:24px;margin-top:10px;word-wrap : break-word ;word-break : break-all ;" onload="this.style.overflowX='auto';">
