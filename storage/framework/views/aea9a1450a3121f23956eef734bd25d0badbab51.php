...
<div id="bbs_con">
	...
	<div class="navigation">
		...
		<div style="float: left;font-size: 14px;line-height: 25px ;height: 25px;">
			<a href="">传承资讯网交易在线</a> →
			<a href="<?php echo e(action('BbsController@fucate',$cate->id)); ?>"><?php echo e($cate->cate); ?></a> →
			<span>帖子列表</span>
		</div>
	</div>
	<br>
	...
	<!-- 顶级分类下的子类模块 -->
	<div class="zxr">
		<b style="margin-left:10px;"><?php echo e($cate->cate); ?>-论坛列表</b>
	</div>
	<div id="zicate">
		<?php $__currentLoopData = $zicates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zicate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div>
			<a href="<?php echo e(action('BbsController@zicate',$zicate->id)); ?>"><?php echo e($zicate->cate); ?></a>
			<div>
				今日帖：
				<font color="red"><?php echo e($zicate->todyPost); ?></font>
				主题帖：<?php echo e($zicate->countPost); ?>

			</div>
			<div>
				发帖总数：<?php echo e($zicate->countReply); ?>
	...
	<div name="batch" style="float:left;width:100%;">
		...
		<div class="list">
			<div class="list_r1">
				...
				<div class="list_c"><?php echo e($post->replies->count('id')); ?></div>
