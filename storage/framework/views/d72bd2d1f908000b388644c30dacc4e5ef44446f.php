...
<div class="">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>修改 <small>文章内容</small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">

            <form action="<?php echo e(action('Admin\ArticleController@updateDetail')); ?>" method="POST" class="form-horizontal form-label-left" novalidate>
              <?php echo e(csrf_field()); ?>

              <p>请输入 <code>修改文章</code> 内容的相关 <a href="form.html">信息</a>
              </p>
              <span class="section">Article Detail</span>

              <input type="hidden" name="id" value="<?php echo e($content->id); ?>">
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" >文章内容</label>
                <div class="col-md-11 col-sm-11 col-xs-12" id='detail'><?php echo $content->content; ?>
