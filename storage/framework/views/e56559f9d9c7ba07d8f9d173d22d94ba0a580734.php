      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="<?php echo e(action('Admin\ArticleController@updateTitle')); ?>" method="POST" class="form-horizontal form-label-left" novalidate>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="title" class="form-control col-md-7 col-xs-12" name="title" value="<?php echo e($article->title); ?>" required="required" type="text">
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="cate_id">
                    <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cate->id); ?>" <?php if($article->cate_id == $cate->id): ?> selected <?php endif; ?>><?php echo e($cate->cate); ?></option>
